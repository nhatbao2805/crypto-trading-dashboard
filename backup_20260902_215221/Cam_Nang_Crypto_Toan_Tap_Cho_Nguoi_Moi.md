...
flowchart LR
    ...
    B["📦 <b>BƯỚC 2</b><br/>Giao dịch gom vào<br/>Khối (Block)"] 
    C["💻 <b>BƯỚC 3</b><br/>Hàng chục ngàn Nodes<br/>xác thực đồng thuận"] 
    D["⛓️ <b>BƯỚC 4</b><br/>Khối khóa mã hóa &<br/>nối vào Blockchain"] 
    E["✅ <b>BƯỚC 5</b><br/>Giao dịch hoàn tất<br/><i>(Bất biến, không thể sửa)</i>"]
...
flowchart TD
    ...
    Root --> BTC["👑 <b>BITCOIN (BTC)</b><br/>Vàng kỹ thuật số - Bản vị dòng tiền"]
    Root --> ALT["🚀 <b>ALTCOINS</b><br/>(Tất cả coin khác ngoài BTC)"]
    
    ALT --> L1["⚡ <b>Layer 1 (Nền tảng chuỗi)</b><br/>Ethereum, Solana, BNB, NEAR, SUI"]
    ALT --> L2["🚄 <b>Layer 2 (Mở rộng & Tăng tốc)</b><br/>Arbitrum, Optimism, Base, Polygon"]
    ALT --> STABLE["💵 <b>Stablecoins (Đồng ổn định)</b><br/>USDT, USDC (Bảo chứng 1:1 USD)"]
    ALT --> WEB3["🔮 <b>DeFi / AI / RWA / DePIN</b><br/>Uniswap, Chainlink, Render, ONDO"]
    ALT --> MEME["🐶 <b>Memecoins (Cộng đồng)</b><br/>DOGE, PEPE, SHIB, WIF"]
...
%%{init: {'theme': 'base', 'themeVariables': { 'lineColor': '#94a3b8'}}}%%
flowchart TD
    Step1["🔭 <b>BƯỚC 1: KHUNG 4H (BẢN ĐỒ CHIẾN LƯỢC)</b><br/>• Xác định Xu hướng chính (Trend): Đang Uptrend hay Downtrend?<br/>• Đánh dấu VÙNG HỖ TRỢ / KHÁNG CỰ CỨNG của tổ chức"]
    Step2["🎯 <b>BƯỚC 2: KHUNG 1H (VÙNG PHỤC KÍCH)</b><br/>• Chờ giá hồi về vùng cản 4H<br/>• Quan sát nến chậm lại, xuất hiện cấu trúc nén giằng co"]
    Step3["⚡ <b>BƯỚC 3: KHUNG 15M (BÓP CÒ VÀO LỆNH)</b><br/>• Tìm mô hình nến đảo chiều (Hammer, Engulfing, SFP quét râu)<br/>• Vào lệnh ngay khi nến 15m đóng cửa<br/>• Đặt Stop Loss siêu chặt dưới râu nến 15m<br/>• Take Profit theo đỉnh/đáy 4H ➔ Tỷ lệ R:R cực đại 1:8 đến 1:15!"]
...
%%{init: {'theme': 'base', 'themeVariables': { 'lineColor': '#94a3b8'}}}%%
flowchart TD
    Macro["🏛️ <b>CÁC YẾU TỐ VĨ MÔ CHI PHỐI DÒNG TIỀN</b>"]
    
    Macro --> FED["🏦 <b>LÃI SUẤT FED (FOMC) & CPI (LẠM PHÁT)</b><br/>• FED hạ lãi suất ➔ Bơm thanh khoản ➔ Crypto bùng nổ (Bullrun)<br/>• FED tăng lãi suất / CPI cao ➔ Hút tiền về ➔ Thị trường ảm đạm"]
    Macro --> DXY["💵 <b>CHỈ SỐ ĐỒNG ĐÔ LA MỸ (DXY)</b><br/>• DXY TĂNG ➔ Dòng tiền rút khỏi tài sản rủi ro (BTC giảm)<br/>• DXY GIẢM ➔ Dòng tiền đổ vào Bitcoin & Altcoins (BTC tăng)"]
    Macro --> STABLE["💎 <b>DÒNG TIỀN STABLECOIN (USDT / USDC)</b><br/>• Tether in thêm hàng tỷ USDT nạp lên sàn ➔ Nhiên liệu đẩy sóng tăng<br/>• Stablecoin bị rút ròng ra USD ➔ Cạn thanh khoản, giá thoái lui"]

    linkStyle default stroke:#38bdf8,stroke-width:2px;

    style Macro fill:#0f172a,stroke:#38bdf8,stroke-width:2px,color:#ffffff
    style FED fill:#1e3a8a,stroke:#3b82f6,stroke-width:1px,color:#ffffff
    style DXY fill:#581c87,stroke:#c084fc,stroke-width:1px,color:#ffffff
    style STABLE fill:#064e3b,stroke:#10b981,stroke-width:1px,color:#ffffff
```
...
%%{init: {'theme': 'base', 'themeVariables': { 'lineColor': '#94a3b8'}}}%%
flowchart LR
    P1["1️⃣ <b>BITCOIN (BTC)</b><br/>Vốn ngoại đổ vào BTC đầu tiên<br/>BTC tăng dẫn dắt thị trường"] 
    P2["2️⃣ <b>ETH & TOP COIN</b><br/>Lợi nhuận BTC chốt sang<br/>Ethereum, Solana, BNB..."] 
    P3["3️⃣ <b>MID / LOW CAP</b><br/>Tiền tràn sang hệ sinh thái,<br/>Layer 2, DeFi, AI, GameFi"] 
    P4["4️⃣ <b>MEMECOINS & RÁC</b><br/>Pha FOMO điên cuồng nhất,<br/>X5, X10 trong vài ngày"]
    P5["5️⃣ <b>STABLECOIN (USDT)</b><br/>Cá mập xả toàn bộ về USDT<br/>Mùa đông điều chỉnh bắt đầu"]

    P1 --> P2 --> P3 --> P4 --> P5 --> P1

    linkStyle default stroke:#f59e0b,stroke-width:2px;

    style P1 fill:#78350f,stroke:#f59e0b,stroke-width:2px,color:#ffffff
    style P2 fill:#1e1b4b,stroke:#818cf8,stroke-width:2px,color:#ffffff
    style P3 fill:#0f766e,stroke:#14b8a6,stroke-width:2px,color:#ffffff
    style P4 fill:#831843,stroke:#f43f5e,stroke-width:2px,color:#ffffff
    style P5 fill:#064e3b,stroke:#10b981,stroke-width:2px,color:#ffffff
```
...
graph TD
    ...
    Step2 --> Step3["BƯỚC 3: Giao Dịch Thử Nghiệm Giả Lập (Paper Trading)<br/>(Thực hành ít nhất 50 lệnh tiền giả để kiểm chứng phương pháp và tỷ lệ R:R)"]
    Step3 --> Step4["BƯỚC 4: Khởi Đầu Vốn Nhỏ Bằng GIAO DỊCH GIAO NGAY (SPOT)<br/>(Chỉ mua coin Top như BTC, ETH bằng số tiền nhàn rỗi, TUYỆT ĐỐI KHÔNG chơi Futures đòn bẩy)"]
    Step4 --> Step5["BƯỚC 5: Viết Nhật Ký Giao Dịch & Hoàn Thiện Kỷ Luật Thép<br/>(Ghi chép chi tiết từng lệnh: Lý do vào lệnh, cảm xúc, bài học rút ra để tiến bộ mỗi ngày)"]
```
