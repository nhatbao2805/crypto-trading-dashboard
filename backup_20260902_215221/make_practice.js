...
// Load the original practice.js
const origJs = fs.readFileSync('public/js/practice.js', 'utf8');

// Let's create an expanded list of 30 cases by enhancing the original 10 cases + adding cases for Ch 1 to Ch 12
const cases = [
  // 1. SFP (Ch 5 & 9)
  {
    id: 1, chapterId: 5, level: 'intermediate', levelLabel: '⚡ Trung Bình',
    category: 'whale_traps', categoryName: '🐋 Bẫy Cá Mập & Quét Sàn (Chương 5 & 9)',
    ...
    chartConfig: {
      ...
      zones: [{ type: 'support', top: 59150, bottom: 58850, label: 'BÃI STOP LOSS EQL (BỂ THANH KHOẢN SSL)' }],
    ...
    options: [
      { id: 'A', text: 'Thủng đáy $59,000 là tín hiệu thị trường sập không phanh ➔ Vào lệnh Bán khống (Short) đuổi theo đà giảm ngay khi thấy nến đỏ đâm xuống $57,600.', isCorrect: false },
      { id: 'B', text: 'Cá mập cố tình tạo 2 đáy EQL để bẫy Stop Loss. Cú đâm sâu rồi rút râu đóng nến bên trong biên là mô hình SFP (Quét thanh khoản gom hàng) ➔ Mở lệnh Long khi nến 15m đóng cửa ($59,450), Stop Loss đặt tại $57,500 (dưới râu nến quét), Take Profit tại đỉnh cũ $64,500 (R:R ≈ 1 : 2.6).', isCorrect: true },
      { id: 'C', text: 'Đây là nến Doji lưỡng lự, tuyệt đối không có tín hiệu mua bán nào.', isCorrect: false },
      { id: 'D', text: 'Chờ giá rơi về $30,000 mới cân nhắc mua.', isCorrect: false }
    ],
  ...
  // 2. Judas Swing (Ch 7 & 9)
  {
    id: 2, chapterId: 7, level: 'advanced', levelLabel: '🔥 Nâng Cao',
    category: 'whale_traps', categoryName: '🐋 Bẫy Cá Mập & Quét Sàn (Chương 7 & 9)',
    ...
    options: [
      { id: 'A', text: 'Tin tốt thì giá chắc chắn sẽ lên $100,000 ➔ Tiếp tục gồng lệnh Mua.', isCorrect: false },
      { id: 'B', text: 'Bẫy Judas Swing: Cá mập dùng tin tốt để xả hàng giá cao ➔ Chờ nến xác nhận đóng cửa dưới đỉnh cũ để MỞ SHORT thuận xu hướng giảm (Entry $63,700, SL $65,900, TP $59,500).', isCorrect: true },
      { id: 'C', text: 'Do sàn bị lỗi máy chủ.', isCorrect: false },
      { id: 'D', text: 'Không làm gì cả.', isCorrect: false }
    ],
  ...
  // 3. Funding Squeeze (Ch 8 & 9)
  {
    id: 3, chapterId: 8, level: 'advanced', levelLabel: '🔥 Nâng Cao',
    category: 'derivatives_data', categoryName: '📊 Dữ Liệu Phái Sinh & Squeeze (Chương 8 & 9)',
    ...
    options: [
      { id: 'A', text: 'Funding âm chứng tỏ phe Short đang áp đảo ➔ Nhắm mắt mở thêm lệnh Short.', isCorrect: false },
      { id: 'B', text: 'Tín hiệu Nén lò xo chuẩn bị SHORT SQUEEZE: Khi Cá mập bơm lệnh Mua, chuỗi thanh lý Short sẽ kích hoạt lệnh Market Buy đẩy giá bay thẳng đứng ➔ Mở Long đón đầu quanh $132, SL $128.5, TP $158 - $162 (R:R = 1 : 6.8)!', isCorrect: true },
      { id: 'C', text: 'SOL sẽ về 0 USD.', isCorrect: false },
      { id: 'D', text: 'Funding không ảnh hưởng tới giá.', isCorrect: false }
    ],
  ...
  // 4. BTC.D Cycle (Ch 9.2)
  {
    id: 4, chapterId: 9, level: 'intermediate', levelLabel: '⚡ Trung Bình',
    category: 'macro_cycle', categoryName: '🌊 Vĩ Mô & Chu Kỳ Dòng Tiền (Chương 9.2)',
    ...
    options: [
      { id: 'A', text: 'Thị trường đang vào Altseason ➔ Vay tiền mua Altcoin.', isCorrect: false },
      { id: 'B', text: 'Thị trường đang ở PHA 1 (Dòng tiền chỉ tập trung kéo BTC, Altcoin bị hút máu) ➔ Giữ chặt BTC và USDT; Chờ BTC đi ngang lập đỉnh và BTC.D đảo chiều giảm mới đón MÙA ALTCOIN (Pha 3)!', isCorrect: true },
      { id: 'C', text: 'Bán cắt lỗ toàn bộ nghỉ chơi.', isCorrect: false },
      { id: 'D', text: 'Short BTC x100 gỡ lỗ.', isCorrect: false }
    ],
  ...
  // 5. Spoofing & CVD (Ch 3 & 9)
  {
    id: 5, chapterId: 9, level: 'advanced', levelLabel: '🔥 Nâng Cao',
    category: 'whale_traps', categoryName: '🐋 Bẫy Cá Mập & Quét Sàn (Chương 3 & 9)',
    ...
    options: [
      { id: 'A', text: 'Sàn bị hack.', isCorrect: false },
      { id: 'B', text: 'Tường 2,500 BTC là bẫy Spoofing để xả hàng; Cú rơi về $60,400 kèm phân kỳ CVD tăng chứng minh Cá mập đang âm thầm hấp thụ toàn bộ lực bán tháo (Absorption) ➔ Tín hiệu gom hàng đáy uy tín!', isCorrect: true },
      { id: 'C', text: 'CVD tăng là in thêm coin.', isCorrect: false },
  ...
  // 6. Futures Spread (Ch 9.4 & 10)
  {
    id: 6, chapterId: 10, level: 'intermediate', levelLabel: '⚡ Trung Bình',
    category: 'risk_execution', categoryName: '🛡️ Quản Trị Rủi Ro Futures (Chương 9.4 & 10)',
    ...
    options: [
      ...
      { id: 'B', text: 'Luôn chuyển loại kích hoạt Stop Loss sang MARK PRICE và đặt SL lùi xa các mốc số tròn 0.3% - 0.5% để tạo vùng đệm an toàn!', isCorrect: true },
      { id: 'C', text: 'Không bao giờ cài SL nữa.', isCorrect: false },
  ...
  // 7. Minor ChoCH vs 4H OB (Ch 6 & 7)
  {
    id: 7, chapterId: 6, level: 'advanced', levelLabel: '🔥 Nâng Cao',
    category: 'macro_cycle', categoryName: '⏱️ Đa Khung Thời Gian & SMC (Chương 6 & 7)',
    ...
    options: [
      { id: 'A', text: '15m ChoCH tăng là all in Long.', isCorrect: false },
      { id: 'B', text: 'Khung nhỏ (15m) phải phục tùng khung lớn (4H). Nhịp tăng 15m chỉ là sóng hồi chạm vùng bán 4H ➔ Chờ nến đảo chiều 15m chạm cản 4H để MỞ SHORT thuận xu hướng chính (Entry $64,500, SL $65,400, TP $60,500)!', isCorrect: true },
      { id: 'C', text: 'Tắt chart 4H đi.', isCorrect: false },
      { id: 'D', text: 'Đánh cả Long và Short.', isCorrect: false }
    ],
  ...
  // 8. Slippage Altcoin (Ch 10)
  {
    id: 8, chapterId: 10, level: 'basic', levelLabel: '🌱 Cơ Bản',
    category: 'risk_execution', categoryName: '🧮 Quản Trị Vốn & Trượt Giá (Chương 10)',
    ...
    options: [
      { id: 'A', text: 'Lỗi sàn lừa đảo.', isCorrect: false },
      { id: 'B', text: 'Vi phạm quy tắc quản trị vốn: Dùng đòn bẩy quá cao (x15) trên coin thanh khoản mỏng ➔ Khắc phục: Với coin rác, mạo hiểm tối đa 0.5% vốn ($25), đòn bẩy tối đa x2-x3 (hoặc chỉ mua Spot)!', isCorrect: true },
      { id: 'C', text: 'Lần sau đánh x50.', isCorrect: false },
      { id: 'D', text: 'Chỉ chơi theo nhóm VIP.', isCorrect: false }
    ],
  ...
  // 9. Wyckoff Spring (Ch 9.3)
  {
    id: 9, chapterId: 9, level: 'advanced', levelLabel: '🔥 Nâng Cao',
    category: 'macro_cycle', categoryName: '🌊 Cấu Trúc Wyckoff & Tích Lũy (Chương 9.3)',
    ...
    chartConfig: {
      ...
      zones: [{ type: 'support', top: 21.0, bottom: 20.0, label: 'BIÊN DƯỚI HỘP TÍCH LŨY' }],
    ...
    options: [
      { id: 'A', text: 'Thủng $20 là sập ➔ Short đuổi.', isCorrect: false },
      { id: 'B', text: 'PHA SPRING (Pha C Wyckoff): Cú rũ bỏ cuối cùng trước sóng Markup ➔ Mở Long khi nến tái tích lũy đóng trong Trading Range ($21.8 - $22.0), SL $17.5 (dưới đáy Spring), TP $25 và $32 (R:R >= 1:5)!', isCorrect: true },
      { id: 'C', text: 'Thị trường mùa đông.', isCorrect: false },
      { id: 'D', text: 'Wyckoff không đúng.', isCorrect: false }
    ],
    explanation: '<b>✅ ĐÁP ÁN ĐÚNG LÀ B (Theo Chương 9.3 - Wyckoff)</b><br>• Spring là cơ hội săn R:R cao nhất trong chu kỳ tích lũy!'
  },

  // 10. DCA Out & Trailing Stop (Ch 10.5)
  {
    id: 10, chapterId: 10, level: 'basic', levelLabel: '🌱 Cơ Bản',
    category: 'risk_execution', categoryName: '🧮 Quản Trị Vị Thế & Tâm Lý (Chương 10.5)',
    ...
    options: [
      { id: 'A', text: 'Gồng 100% không chốt đồng nào, vay thêm mua ở $96k.', isCorrect: false },
      { id: 'B', text: 'Bán sạch 100% tiền mặt ngay lập tức.', isCorrect: false },
      { id: 'C', text: 'Chiến lược DCA Out 3 Bước: Chốt trước 30-40% ở $96k khóa tiền thật; Dời SL bảo vệ cho 60% còn lại về mức $88,000 (đáy 4H gần nhất) để thả trôi lợi nhuận không rủi ro!', isCorrect: true },
      { id: 'D', text: 'Chuyển toàn bộ lãi sang mua memecoin.', isCorrect: false }
    ],
    explanation: '<b>✅ ĐÁP ÁN ĐÚNG LÀ C (Theo Chương 10.4 & 10.5)</b><br>• Tiền chỉ là của bạn khi bạn đã bấm chốt lời!'
  },

  // 11. Immutability (Ch 1)
  {
    id: 11, chapterId: 1, level: 'basic', levelLabel: '🌱 Cơ Bản',
    category: 'blockchain_basics', categoryName: '⛓️ Bản Chất Blockchain (Chương 1)',
    ...
    options: [
      { id: 'A', text: 'Hủy được nếu liên hệ sàn trong 24h.', isCorrect: false },
      { id: 'B', text: 'KHÔNG THỂ HỦY HOẶC ĐẢO NGƯỢC: Tính bất biến (Immutability) của Blockchain khiến không ai có quyền đảo ngược giao dịch khi đã được các node xác thực.', isCorrect: true },
      { id: 'C', text: 'Ngân hàng can thiệp thu hồi được.', isCorrect: false },
      { id: 'D', text: 'Tắt mạng điện thoại để hoàn tiền.', isCorrect: false }
    ],
  ...
  // 12. 51% Attack (Ch 1)
  {
    id: 12, chapterId: 1, level: 'intermediate', levelLabel: '⚡ Trung Bình',
    category: 'blockchain_basics', categoryName: '⛓️ Cơ Chế Đồng Thuận (Chương 1)',
    ...
    options: [
      { id: 'A', text: 'Chỉ giao dịch và nắm giữ các mạng Blockchain có quy mô hashrate khổng lồ (như Bitcoin, Ethereum) hoặc yêu cầu số block xác nhận cao (30-60 confirmations) với chain nhỏ.', isCorrect: true },
      { id: 'B', text: 'Nạp thêm tiền bắt đáy khi bị tấn công 51%.', isCorrect: false },
      { id: 'C', text: 'Bắt chính phủ bồi thường.', isCorrect: false },
      { id: 'D', text: 'Tấn công 51% là tin giả.', isCorrect: false }
    ],
  ...
  // 13. Phishing Seed Phrase (Ch 2)
  {
    id: 13, chapterId: 2, level: 'basic', levelLabel: '🌱 Cơ Bản',
    category: 'wallet_security', categoryName: '🛡️ Bảo Mật Ví & Seed Phrase (Chương 2)',
    ...
    options: [
      { id: 'A', text: 'Cung cấp 12 từ khóa để sửa lỗi nhanh.', isCorrect: false },
      { id: 'B', text: 'TUYỆT ĐỐI KHÔNG CUNG CẤP: Không có admin hay đội ngũ hỗ trợ nào được phép xin 12 từ khóa Seed Phrase. Đây là lừa đảo 100% rút sạch tài sản!', isCorrect: true },
      { id: 'C', text: 'Chỉ gửi 6 từ đầu.', isCorrect: false },
      { id: 'D', text: 'Chụp ảnh màn hình gửi qua.', isCorrect: false }
    ],
    explanation: '<b>✅ ĐÁP ÁN ĐÚNG LÀ B (Theo Chương 2.2)</b><br>• Lộ 12 từ khóa Seed Phrase = Mất sạch toàn bộ tài sản!'
  },

  // 14. Spot vs Futures Leverage (Ch 2)
  {
    id: 14, chapterId: 2, level: 'intermediate', levelLabel: '⚡ Trung Bình',
    category: 'wallet_security', categoryName: '🪙 Spot vs Futures & Đòn Bẩy (Chương 2)',
    ...
    options: [
      { id: 'A', text: 'Vẫn an toàn và lãi lớn khi giá bay lên.', isCorrect: false },
      { id: 'B', text: 'BỊ THANH LÝ CHÁY SẠCH 100% VỐN: Với đòn bẩy x50, biên độ chịu giá chỉ 1.8%-2.0%. Khi đã cháy tài khoản về 0 thì giá bay sau đó vô nghĩa!', isCorrect: true },
      { id: 'C', text: 'Sàn tự bù tiền cho vay gồng.', isCorrect: false },
      { id: 'D', text: 'Chỉ mất $36.', isCorrect: false }
    ],
    explanation: '<b>✅ ĐÁP ÁN ĐÚNG LÀ B (Theo Chương 2.3)</b><br>• Đòn bẩy cao biến biến động nhỏ thành thảm họa cháy sạch vốn.'
  },

  // 15. Limit vs Market Order (Ch 3)
  {
    id: 15, chapterId: 3, level: 'intermediate', levelLabel: '⚡ Trung Bình',
    category: 'orderbook_liquidity', categoryName: '📊 Khớp Lệnh & Bể Thanh Khoản (Chương 3)',
    ...
    options: [
      { id: 'A', text: 'Khớp chính xác mức giá hiển thị lúc bấm.', isCorrect: false },
      { id: 'B', text: 'Lệnh Market quét qua các tầng giá bán mỏng và khớp ở mức giá cao bất lợi trên đỉnh sổ lệnh do hiện tượng trượt giá!', isCorrect: true },
      { id: 'C', text: 'Sàn hoàn tiền trượt giá.', isCorrect: false },
      { id: 'D', text: 'Lệnh bị hủy.', isCorrect: false }
    ],
    explanation: '<b>✅ ĐÁP ÁN ĐÚNG LÀ B (Theo Chương 3.1)</b><br>• Khi thị trường biến động mạnh, luôn ưu tiên dùng lệnh Limit.'
  },

  // 16. BSL Liquidity Pool (Ch 3)
  {
    id: 16, chapterId: 3, level: 'advanced', levelLabel: '🔥 Nâng Cao',
    category: 'orderbook_liquidity', categoryName: '📊 Bể Thanh Khoản BSL/SSL (Chương 3)',
    ...
    options: [
      { id: 'A', text: 'Cá mập mua gom thêm.', isCorrect: false },
      { id: 'B', text: 'Cá mập dùng thanh khoản mua bắt buộc của phe Short (BSL) làm đối ứng để phân phối chốt lời khối lượng lớn ở giá đỉnh!', isCorrect: true },
      { id: 'C', text: 'Lỗi đường truyền.', isCorrect: false },
      { id: 'D', text: 'Tín hiệu mua tất tay.', isCorrect: false }
    ],
    explanation: '<b>✅ ĐÁP ÁN ĐÚNG LÀ B (Theo Chương 3.2 & 9.4)</b><br>• Bể thanh khoản đỉnh BSL là nơi Cá mập xả hàng giá cao cho retail.'
  },

  // 17. Morning Star (Ch 4)
  {
    id: 17, chapterId: 4, level: 'basic', levelLabel: '🌱 Cơ Bản',
    category: 'candlestick_patterns', categoryName: '🕯️ Mô Hình Nến Đảo Chiều (Chương 4)',
    ...
    options: [
      { id: 'A', text: 'Vào Short ngay.', isCorrect: false },
      { id: 'B', text: 'Mở Long khi Nến 3 đóng cửa xác nhận, Stop Loss dưới đáy nến Doji, Take Profit tại kháng cự đỉnh cũ (R:R >= 1:2).', isCorrect: true },
      { id: 'C', text: 'Chờ giá giảm 50% mới vào.', isCorrect: false },
      { id: 'D', text: 'Không đặt Stop Loss.', isCorrect: false }
    ],
    explanation: '<b>✅ ĐÁP ÁN ĐÚNG LÀ B (Theo Chương 4.2)</b><br>• Cụm Morning Star báo hiệu phe Bò đã kiểm soát lại thị trường.'
  },

  // 18. Shooting Star (Ch 4)
  {
    id: 18, chapterId: 4, level: 'intermediate', levelLabel: '⚡ Trung Bình',
    category: 'candlestick_patterns', categoryName: '🕯️ Nến Shooting Star & Bẫy Đỉnh (Chương 4)',
    ...
    options: [
      { id: 'A', text: 'Tín hiệu mua đuổi.', isCorrect: false },
      { id: 'B', text: 'Cảnh báo phe mua đã kiệt sức và bị phe bán xả hàng chặn đứng ➔ Chốt lời Long hoặc canh mở Short với SL trên đỉnh râu nến!', isCorrect: true },
      { id: 'C', text: 'Shooting star không có ý nghĩa khi tăng mạnh.', isCorrect: false },
      { id: 'D', text: 'Mua gấp đôi.', isCorrect: false }
    ],
    explanation: '<b>✅ ĐÁP ÁN ĐÚNG LÀ B (Theo Chương 4.1)</b><br>• Râu nến trên dài thể hiện sự từ chối giá cao quyết liệt từ phe Gấu.'
  },

  // 19. Break & Retest (Ch 5)
  {
    id: 19, chapterId: 5, level: 'basic', levelLabel: '🌱 Cơ Bản',
    category: 'support_resistance', categoryName: '🏢 Chuyển Đổi Vai Trò Break & Retest (Chương 5)',
    ...
    options: [
      { id: 'A', text: 'Mua đuổi tại đỉnh nến Breakout.', isCorrect: false },
      { id: 'B', text: 'Vào Mua khi giá Retest thành công cản cũ có nến rút chân + Volume thấp, SL dưới vùng cản, TP tại đỉnh mục tiêu tiếp theo.', isCorrect: true },
      { id: 'C', text: 'Mở Short vì giá đang giảm.', isCorrect: false },
      { id: 'D', text: 'Chờ giá về 0.', isCorrect: false }
    ],
    explanation: '<b>✅ ĐÁP ÁN ĐÚNG LÀ B (Theo Chương 5.4)</b><br>• Vào lệnh tại nhịp Retest giúp tối ưu R:R và có Stop Loss cực ngắn.'
  },

  // 20. Market Structure Break (Ch 6)
  {
    id: 20, chapterId: 6, level: 'basic', levelLabel: '🌱 Cơ Bản',
    category: 'market_structure_smc', categoryName: '📈 Cấu Trúc Xu Hướng HH/HL (Chương 6)',
    ...
    options: [
      { id: 'A', text: 'Uptrend vẫn giữ nguyên, mua tiếp.', isCorrect: false },
      { id: 'B', text: 'Cấu trúc tăng đã chính thức BỊ BẺ GÃY (Tín hiệu CHoCH), xác suất cao chuyển sang Downtrend hoặc Sideway rộng ➔ Dừng mua, canh kịch bản hồi test để Short.', isCorrect: true },
      { id: 'C', text: 'Thị trường tăng 10 lần.', isCorrect: false },
      { id: 'D', text: 'Lỗi sàn.', isCorrect: false }
    ],
  ...
  // 21. Killzones (Ch 7)
  {
    id: 21, chapterId: 7, level: 'intermediate', levelLabel: '⚡ Trung Bình',
    category: 'multi_timeframe', categoryName: '⏱️ Đa Khung Thời Gian & Killzones (Chương 7)',
    ...
    options: [
      { id: 'A', text: 'Canh 24/24 vào lệnh liên tục trong phiên Á.', isCorrect: false },
      { id: 'B', text: 'Hạn chế trade phiên Á thanh khoản mỏng; Tập trung vào London Open (14:30 - 17:30) và New York Open (19:30 - 23:00) khi dòng tiền tổ chức tham gia mạnh nhất!', isCorrect: true },
      { id: 'C', text: 'Chỉ trade lúc 3h sáng.', isCorrect: false },
      { id: 'D', text: 'Khung giờ nào cũng như nhau.', isCorrect: false }
    ],
  ...
  // 22. Bullish Divergence (Ch 8)
  {
    id: 22, chapterId: 8, level: 'intermediate', levelLabel: '⚡ Trung Bình',
    category: 'volume_vsa', categoryName: '📊 Khối Lượng VSA & Phân Kỳ (Chương 8)',
    ...
    options: [
      { id: 'A', text: 'Đà giảm đang mạnh hơn ➔ Short đuổi.', isCorrect: false },
      { id: 'B', text: 'Phân kỳ tăng giá (Bullish Divergence): Lực bán đã suy kiệt dù giá rơi sâu hơn, dự báo xác suất đảo chiều tăng rất cao ➔ Canh Long khi có nến xác nhận.', isCorrect: true },
      { id: 'C', text: 'RSI vô dụng.', isCorrect: false },
      { id: 'D', text: 'Bán tháo danh mục.', isCorrect: false }
    ],
    explanation: '<b>✅ ĐÁP ÁN ĐÚNG LÀ B (Theo Chương 8.2)</b><br>• Phân kỳ đáy RSI là chỉ báo sớm uy tín báo hiệu cạn kiệt lực bán.'
  },

  // 23. Top Down 4H-1H-15M (Ch 7)
  {
    id: 23, chapterId: 7, level: 'intermediate', levelLabel: '⚡ Trung Bình',
    category: 'multi_timeframe', categoryName: '⏱️ Đa Khung 4H ➔ 1H ➔ 15M (Chương 7)',
    ...
    options: [
      { id: 'A', text: 'Nhìn 1m trước rồi đoán 4H.', isCorrect: false },
      { id: 'B', text: 'Bước 1: Khung 4H xác định Xu Hướng Chính ➔ Bước 2: Khung 1H xác định Vùng Cản Hỗ Trợ/Kháng Cự (POI) ➔ Bước 3: Khung 15m tìm Mô hình Nến kích hoạt Entry & Điểm đặt SL tối ưu.', isCorrect: true },
      { id: 'C', text: 'Chỉ cần xem 1 khung duy nhất.', isCorrect: false },
      { id: 'D', text: 'Xem tin tức Twitter rồi vào lệnh.', isCorrect: false }
    ],
  ...
  // 24. Climax Volume (Ch 8)
  {
    id: 24, chapterId: 8, level: 'advanced', levelLabel: '🔥 Nâng Cao',
    category: 'volume_vsa', categoryName: '📊 Khối Lượng Cao Trào Selling Climax (Chương 8)',
    ...
    options: [
      { id: 'A', text: 'Tất cả mọi người đều muốn bán, thị trường sắp về 0.', isCorrect: false },
      { id: 'B', text: 'Lực bán tháo hoảng loạn của đám đông đã bị dòng tiền lớn (Smart Money) nhảy vào hấp thụ toàn bộ bằng lệnh mua đối ứng ➔ Tín hiệu chuẩn bị tạo đáy đảo chiều!', isCorrect: true },
      { id: 'C', text: 'Lỗi dữ liệu sàn.', isCorrect: false },
      { id: 'D', text: 'Mở Short thêm đòn bẩy x50.', isCorrect: false }
    ],
  ...
  // 25. Tokenomics & FDV (Ch 2)
  {
    id: 25, chapterId: 2, level: 'intermediate', levelLabel: '⚡ Trung Bình',
    category: 'wallet_security', categoryName: '🪙 Tokenomics & Định Giá FDV (Chương 2)',
    ...
    options: [
      { id: 'A', text: 'Coin sẽ tăng giá vì nguồn cung lưu thông ban đầu ít.', isCorrect: false },
      { id: 'B', text: 'RỦI RO LẠM PHÁT XẢ HÀNG KHỔNG LỒ: Lượng token trả về hàng tháng cho các quỹ giá rẻ sẽ tạo áp lực bán liên tục đè bẹp giá coin trong dài hạn ➔ Tránh hold dài hạn các coin có FDV quá chênh lệch so với Market Cap!', isCorrect: true },
      { id: 'C', text: 'FDV không có ý nghĩa đối với giá coin.', isCorrect: false },
      { id: 'D', text: 'Quỹ đầu tư không bao giờ bán coin.', isCorrect: false }
    ],
  ...
  // 26. Equal Highs EQH Trap (Ch 5 & 9)
  {
    id: 26, chapterId: 5, level: 'intermediate', levelLabel: '⚡ Trung Bình',
    category: 'whale_traps', categoryName: '🐋 Bẫy Đỉnh Bằng Equal Highs (Chương 5 & 9)',
    ...
    options: [
      { id: 'A', text: 'Giá sẽ rơi thẳng từ $65,000 cho phe Short ăn đậm.', isCorrect: false },
      { id: 'B', text: 'Cá mập sẽ đẩy một nhịp râu chọc qua $65,300 để quét sạch Stop Loss của phe Short (quét BSL) rồi mới xả hàng quay đầu giảm!', isCorrect: true },
      { id: 'C', text: 'Giá đi ngang vĩnh viễn.', isCorrect: false },
      { id: 'D', text: 'Sàn tự đóng lệnh Short.', isCorrect: false }
    ],
  ...
  // 27. Memecoin Mania Top (Ch 9.2)
  {
    id: 27, chapterId: 9, level: 'intermediate', levelLabel: '⚡ Trung Bình',
    category: 'macro_cycle', categoryName: '🌊 Nhận Diện Đỉnh Chu Kỳ Memecoin (Chương 9.2)',
    ...
    options: [
      { id: 'A', text: 'Thị trường mới bắt đầu ➔ Vay tiền mua memecoin.', isCorrect: false },
      { id: 'B', text: 'Thị trường đang ở Pha 4 (Sóng Memecoin cuối cùng) chuẩn bị vào Pha 5 (Xả về USDT & Sập) ➔ Lập tức chốt lời từng phần (DCA Out) ra USDT bảo toàn vốn!', isCorrect: true },
      { id: 'C', text: 'Memecoin sẽ thay thế BTC.', isCorrect: false },
  ...
  // 28. Cooldown Rule (Ch 10.5)
  {
    id: 28, chapterId: 10, level: 'intermediate', levelLabel: '⚡ Trung Bình',
    category: 'risk_execution', categoryName: '🧠 Kiểm Soát Tâm Lý Cay Cú (Chương 10.5)',
    ...
    options: [
      { id: 'A', text: 'Vào lệnh tiếp vì cơ hội không chờ đợi.', isCorrect: false },
      { id: 'B', text: 'Áp dụng Quy tắc Cooldown 24H: Lập tức tắt máy tính rời khỏi bàn làm việc 24h để tránh Revenge Trading làm tê liệt lý trí!', isCorrect: true },
      { id: 'C', text: 'Nâng đòn bẩy lên x100 để gỡ.', isCorrect: false },
      { id: 'D', text: 'Hỏi bạn bè trên mạng.', isCorrect: false }
    ],
  ...
  // 29. Fair Value Gap FVG (Ch 11)
  {
    id: 29, chapterId: 11, level: 'advanced', levelLabel: '🔥 Nâng Cao',
    category: 'market_structure_smc', categoryName: '🏛️ Khối Lệnh Order Block & FVG (Chương 11)',
    ...
    options: [
      { id: 'A', text: 'Mở Short vì giá đang giảm.', isCorrect: false },
      { id: 'B', text: 'Vào lệnh Mua khi giá lấp đầy vùng FVG ($2,440 - $2,460) và có nến rút chân xác nhận, SL dưới đáy Nến 1 ($2,390), TP đỉnh cũ $2,750 (R:R ≈ 1 : 5.0)!', isCorrect: true },
      { id: 'C', text: 'FVG không có ý nghĩa.', isCorrect: false },
      { id: 'D', text: 'Chờ giá về $1,000.', isCorrect: false }
    ],
  ...
  // 30. Trade Journal & 5 Steps (Ch 12)
  {
    id: 30, chapterId: 12, level: 'basic', levelLabel: '🌱 Cơ Bản',
    category: 'trading_roadmap', categoryName: '🗺️ Lộ Trình 5 Bước Trader (Chương 12)',
    ...
    options: [
      { id: 'A', text: 'Cả hai có kết quả ngẫu nhiên như nhau.', isCorrect: false },
      { id: 'B', text: 'Trader B tích lũy được dữ liệu thống kê khách quan, nhận diện được sai lầm (overtrading, dời SL) và trở thành Trader có lợi nhuận nhất quán; còn Trader A dễ cháy tài khoản vì lặp lại sai lầm cũ!', isCorrect: true },
      { id: 'C', text: 'Viết nhật ký tốn thời gian vô ích.', isCorrect: false },
      { id: 'D', text: 'Trader A giỏi hơn vì không bị gò bó kỷ luật.', isCorrect: false }
    ],
...
// Extract UI functions from original practice.js
// Let's replace the top array and stats with our updated 30 cases
const jsonString = JSON.stringify(cases, null, 2);

const newPracticeJs = `// --- MODULE 2: INTERACTIVE TRADING PRACTICE & CASE STUDIES (30 CASES ACROSS 12 CHAPTERS) ---
...
const practiceScenarios = ${jsonString};
...
fs.writeFileSync('public/js/practice.js', newPracticeJs, 'utf8');
console.log('Successfully updated public/js/practice.js with 30 cases across 12 chapters!');
